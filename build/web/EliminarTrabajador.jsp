...
<html>
    ...
    <body>
            ...
            <div id="content">
                <form name="BuscarTrabajador" method="POST" action="EliminarTrabajador.jsp">
                ...
                <form name="EliminarTrabajador" method="POST" action="Check/EliminarTrabajadorCheck.jsp">
                <h3>Eliminar Trabajador (JobSeeker)</h3>
                <table cellspacing="5" cellpadding="5">
                    <tr>
                        <td>DUI:</td>
