...
<html>
    ...
    <body>
            ...
            <div id="content">
                <form name="Empresa" method="POST" action="IngresarEmpresaCheck.jsp">
                    <h3>Ingresar Empresa</h3>
                    <table cellspacing="5" cellpadding="5">
                        <tr>
                            <td>NIT:</td>
                            <td><input type="text" value="" name="NIT" placeholder="0123-010190-100-1" required pattern="\d{4}-\d{6}-\d{3}-\d{1}"/></td>
                        </tr>
                        <tr>
