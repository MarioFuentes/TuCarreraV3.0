...
<html>
    ...
    <body>
            ...
            <div id="content">
                <form name="Trabajador" method="POST" action="IngresarTrabajadorCheck.jsp">
                <h3>Trabajador (JobSeeker)</h3>
                <table cellspacing="5" cellpadding="5">
                    <tr>
                        <td>DUI:</td>
                        <td><input type="text" value="" name="DUI" required pattern="\d{8}-\d{1}" size="10" placeholder="01234567-1"/></td>
                    </tr>
                    <tr>
                        <td>Nombres:</td>
