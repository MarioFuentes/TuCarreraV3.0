...
<html>
    ...
    <body>
            ...
            <div id="content">
                ...
                <form name="BuscarOfertasEmpleo" method="POST" action="Check/ModificarOfertasEmpleo.jsp">
                ...
                <form name="ModificarOfertasEmpleo" method="POST" action="Check/ModificarOfertasEmpleoCheck.jsp">
                    <table cellspacing="5" cellpadding="5">
                        <tr>
                            <td>NIT:</td>
                            <td>
